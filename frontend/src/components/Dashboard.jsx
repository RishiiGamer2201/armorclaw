...
export default function Dashboard({ onReturnHome }) {
  ...
  // To allow Sidebar to inject prompts
  ...
  const handleSidebarClick = (promptText) => {
    setActiveTab("Agent");
  ...
  return (
    <div className="app-layout" style={{ display: "flex", height: "100vh", overflow: "hidden" }}>
      ...
      <Sidebar onFeatureClick={handleSidebarClick} onReturnHome={onReturnHome} />

      <div className="dashboard-content" style={{ flex: 1, overflowY: "auto", display: "flex", flexDirection: "column" }}>
